...
{ 
    ...
    {
        private Activity() { }
        private static Activity _insance = new Activity();
        ...
        public IEnumerable<Model.ActivityNeme> GetActivityNames()
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
        ...
        public int UpdateVerify(Model.Activity active)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                string sql = "update activity set activityVerify=@activityVerify where activiyid=@activityId";
                return cn.Execute(sql, active);
            }
        }
        public int Delete(int id)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                string sql = "delete from activity where activiyid=@id";
        ...
        public int UpdateRecommend(Model.Activity activity)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                string sql = "update activity set recommend=@recommend,recommendTime=@recommendTime where activiyid=@activityId";
